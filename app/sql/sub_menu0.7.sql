...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2021 at 10:14 AM
...
(25, 'Request Branch', 'requestbranch_dashboard', 'fa fa-building-o', 1, 6),
...
--
ALTER TABLE `sub_menu`
  MODIFY `sm_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
COMMIT;
