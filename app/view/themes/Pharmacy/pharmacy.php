...
<style>
    ...
    .sc-theme-default{width:100%; color:black;}
    .panel-heading{width: 100%;margin: 5px 0px;font-size: 14px;font-weight: 600;}
    .sc-cart-item-list{font-size:14px;}
    .list-group-item{padding: 10px 0px; margin-bottom:3px; display: flex;justify-content: center;flex-wrap:wrap;align-items: center;border:none;border-top:1px solid rgba(0,0,0,0.2); color:black;}
    ...
    .section3{flex-basis:35%;}
    .section4{flex-basis:35%;overflow:hidden;}
